...
The infrastructure layer is built using enterprise-grade frameworks and highly scalable data engines optimized for modern web throughput.

| Component | Technology | Version | Description |
| :--- | :--- | :--- | :--- |
| **Runtime Environment** | ![.NET](https://img.shields.io/badge/.NET-512BD4?style=for-the-badge&logo=dotnet&logoColor=white) | `10.0 (LTS)` | High-performance backend execution environment. |
| **Database Engine** | ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=for-the-badge&logo=postgresql&logoColor=white) | `17.x` | Relational database handling strict asset data integrity. |
| **Object-Relational Mapper** | ![EF Core](https://img.shields.io/badge/EF%20Core%2010-512BD4?style=for-the-badge&logo=dotnet&logoColor=white) | `10.0` | Strongly-typed data mapping and migration orchestration. |
| **Security & Auth** | ![JWT](https://img.shields.io/badge/JWT-000000?style=for-the-badge&logo=json-web-tokens&logoColor=white) | `Bearer` | Cryptographically signed tokens for stateless authorization. |
| **API Documentation** | ![Swagger](https://img.shields.io/badge/Swagger-85EA2D?style=for-the-badge&logo=swagger&logoColor=black) | `OpenAPI 3.0` | Autogenerated structural definitions and testing sandbox. |
| **Code Generation** | ![QRCoder](https://img.shields.io/badge/QRCoder-FF0000?style=for-the-badge&logo=qrcode&logoColor=white) | `Core-Native` | Matrix barcode pixel manipulation engine. |
